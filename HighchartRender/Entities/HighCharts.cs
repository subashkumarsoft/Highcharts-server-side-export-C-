...
namespace HighchartRender.Entities
{
    public class HighChartsPlotOptions
    {
        ...
        public HighChartsLinePlotOptions line { get; set; }
    ...
    public class HighChartsColumnPlotOptions
    {
        ...
        public HighChartsMarker marker { get; set; }
    }

    public class HighChartsLinePlotOptions
    {
        public HighChartsMarker marker { get; set; }
    }
    ...
    public class HighChartsNoLang
    {
        public string noData { get; set; } = "No data to display in this date range";
    }

    public class HighChartsNoData
    {
